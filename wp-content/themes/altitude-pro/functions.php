...
add_image_size( 'portfolio_image_large', 500, 500, false );
add_image_size( 'portfolio_image_thumb', 250, 250, false );
...
function portfolio_post_type_install() {
    ...
    // Trigger the function that registers the Performances custom post type
    portfolio_post_type();
