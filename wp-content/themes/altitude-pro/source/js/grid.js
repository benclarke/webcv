// overriding WP jquery no conflict
...
var Grid = (function() {
	...
	Preview.prototype = {
		create : function() {
			...
			this.$title = $( '<h3></h3>' );
			this.$description = $( '<div class="portfolio-text"></div>' );
...
// was going to flip everything when you got to the bottom...
// $(window).scroll(function() {
//    if($(window).scrollTop() + $(window).height() >= $(document).height() - 200 ) {
//       $('.container').addClass('reversed');
//    } else {
//    		$('.container').removeClass('reversed');
//    }
// });


}); //closing out the jQuery no conflict override